...
if (VBM !=0) or (Eg !=0):
  ...
  plt.text(VBM-0.3, text_y_position-7, 'VBM', fontsize=12)
  plt.text(Eg+0.3, text_y_position-7, 'CBM', fontsize=12)
  plt.title('Pristine Supercell')
#
#############################################################################################################
...
#  print i
  ...
  if (all_data[3][-1]=="4"):
     plt.plot(energy, l0, label='s', color='purple', lw=2)
     plt.plot(energy, l1, label='p', color='blue', lw=2)
     plt.plot(energy, l2, label='d', color='green', lw=2)
     plt.plot(energy, l3, label='f', color='red', lw=2)
     plt.plot(energy, l4, label='g', color='orange', lw=2)
  if (all_data[3][-1]=="3"):
    plt.plot(energy, l0, label='s', color='purple', lw=2)
    plt.plot(energy, l1, label='p', color='blue', lw=2)
    plt.plot(energy, l2, label='d', color='green', lw=2)
