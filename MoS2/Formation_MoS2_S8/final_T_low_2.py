...
ax.plot_surface(Y, X, VMo.T, rstride=1, cstride=1,color='orange')
...
ax.plot_surface(Y, X, VMo_2.T, rstride=1, cstride=1,color='orange')
ax.set_xlabel(' Tempreture [k]')
ax.set_zlabel(' Formation Energy [eV]')
ax.set_ylabel(' Pressure [atm]')
...
ax.plot_surface(Y, X, conc_VMo_1.T, rstride=1, cstride=1,color='yellow')
ax.set_xlabel(' Tempreture [k]')
...
ax.plot_surface(Y, X, conc_VMo_2.T, rstride=1, cstride=1,color='yellow')
ax.set_xlabel(' Tempreture [k]')
ax.set_zlabel(' Defect Concentration')
ax.set_ylabel(' Pressure [atm]')
ax.set_title('MoS2 high S environment')
