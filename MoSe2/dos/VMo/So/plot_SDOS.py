...
species=['Mo0019','Mo0022','Mo0034','Mo0039','Mo0051','Mo0054']
...
#  print i
  ...
  #if (all_data[3][-1]=="4"):
  plt.plot(energy, l0, label='s', color='purple', lw=1,ms=1 )
  plt.plot(energy, l1, label='p', color='blue', lw=1,ms=1)
  plt.plot(energy, l2, label='d', color='green', lw=1,ms=1)
  plt.plot(energy, l3, label='f', color='red', lw=1,ms=1)
  plt.plot(energy, l4, label='g', color='orange', lw=1,ms=1)
  #if (VBM !=0) or (Eg !=0):
...
plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.6), fancybox=True, shadow=True, ncol=5,fontsize='small')
plt.savefig('ldos_Mo.pdf')
