...
E0=-11861391.302574463 # pristine
E1=-11872270.607507527 # addon S
E2=-11850507.509367829 # mono S vacancy
E3=-11839623.889401967 # di S vacancy up&down
E4=-11839622.665039312 # di S vacancy neighboring
E5=-11408691.435644289 # mono W vacancy
E_WS2=-474455.649887723 # primtitive
...
#ax = plt.axes(projection='3d')
ax.plot_surface(Y, X, addS.T, rstride=1, cstride=1,color='r',shade=False)
ax.plot_surface(Y, X, VS.T, rstride=1, cstride=1,color='b',shade=False)
ax.plot_surface(Y, X, VS2.T, rstride=1, cstride=1,color='g',shade=False)
ax.plot_surface(Y, X, VS22.T, rstride=1, cstride=1,color='k',shade=False)
ax.plot_surface(Y, X, VW.T, rstride=1, cstride=1,color='orange',shade=False)
...
ax.set_title('WS2 low S environment',fontsize=14)
#===============
# Second subplot
#===============
...
ax.plot_surface(Y, X, addS_2.T, rstride=1, cstride=1,color='r',shade=False)
#ax.set_legend(fontsize=7)
ax.plot_surface(Y, X, VS_2.T, rstride=1, cstride=1,color='b',shade=False)
ax.plot_surface(Y, X, VS2_2.T, rstride=1, cstride=1,color='g',shade=False)
ax.plot_surface(Y, X, VS22_2.T, rstride=1, cstride=1,color='k',shade=False)
ax.plot_surface(Y, X, VW_2.T, rstride=1, cstride=1,color='orange',shade=False)
ax.set_xlabel(' Tempreture [k]',fontsize=14)
ax.set_zlabel(' Formation Energy [eV]',fontsize=14)
ax.set_ylabel(' Pressure [atm]',fontsize=14)
ax.set_title('WS2 high S environment',fontsize=14)
...
ax.legend([b1, b2,b3,b4,b5], ['adatom', 'Mono S', 'di up$\&$down','di neigh','Mono Mo'],bbox_to_anchor =(-1.0, 1.0))
...
ax.plot_surface(Y, X, conc_VW_1.T, rstride=1, cstride=1,color='orange',shade=False)
...
ax.plot_surface(Y, X, conc_VW_2.T, rstride=1, cstride=1,color='orange',shade=False)
ax.legend([b1, b2,b3,b4], ['adatom', 'Mono', 'di up$\&$down','di neigh'])
ax.set_xlabel(' Tempreture [k]')
ax.set_zlabel(' Defect Concentration')
ax.set_ylabel(' Pressure [atm]')
