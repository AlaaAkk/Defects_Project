...
E0=-14644824.983369252 # pristine
E1=-14711372.759935336 # addon S
E2=-14578272.157604560 # mono S vacancy
E3=-14511720.031441867 # di S vacancy up&down
E4=-14511719.582327334 # di S vacancy neighboring
E5=-14192126.633933334 # -14192151.211700918 mono Mo vacancy
E_WSe2=-585792.997134696 # primtitive
...
ax.set_title('WSe2 low Se environment',fontsize=14)
#===============
# Second subplot
#===============
...
ax.set_zlabel(' Formation Energy [eV]',fontsize=14)
ax.set_ylabel(' Pressure [atm]',fontsize=14)
ax.set_title('WSe2 high Se environment',fontsize=14)
...
ax.legend([b1, b2,b3,b4,b5], ['adatom', 'Mono Se', 'di up$\&$down','di neigh','Mono W'],bbox_to_anchor =(-1.0, 1.0))
plt.show()
